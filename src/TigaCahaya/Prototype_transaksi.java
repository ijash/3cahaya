 ...
 * @author Jose
 */
public class Prototype_transaksi extends javax.swing.JFrame {

    /**
     * Creates new form Prototype_transaksi
     */
    public Prototype_transaksi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "invoice", "tanggal", "jam", "id barang", "Jumlah", "harga", "diskon", "uang bayar", "garansi", "ID", "keterangan"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prototype_transaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prototype_transaksi().setVisible(true);
            }
        });
    }
