 ...
 * @author Jose
 */
public class prototype_Retur extends javax.swing.JFrame {

    /**
     * Creates new form prototype_Retur
     */
    public prototype_Retur() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prototype_Retur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prototype_Retur().setVisible(true);
            }
        });
    }
